...
use {
    crate::{
        deprecated_state::AuctionManagerV1, error::UniMoonError, utils::try_from_slice_checked,
    },
...
pub fn get_auction_manager(account: &AccountInfo) -> Result<Box<dyn AuctionManager>, ProgramError> {
    ...
    match version {
        ...
        _ => return Err(UniMoonError::DataTypeMismatch.into()),
    };
}
#[repr(C)]
...
impl AuctionManager for AuctionManagerV2 {
    ...
    fn get_number_of_unique_token_types_for_this_winner(
        ...
        if let Some(tracker_info) = auction_token_tracker_info {
            ...
            return Err(UniMoonError::NoTokensForThisWinner.into());
        } else {
            return Err(UniMoonError::InvalidOperation.into());
        }
    }
...
impl SafetyDepositConfig {
    ...
    pub fn find_amount_and_cumulative_offset(
        ...
        if not_found {
            return Err(UniMoonError::WinnerIndexNotFound.into());
        }
    ...
    pub fn check_ticket(
        ...
        if bid_redemption_data[0] == Key::BidRedemptionTicketV1 as u8 {
            ...
            if is_participation && participation_redeemed {
                return Err(UniMoonError::BidAlreadyRedeemed.into());
            }
            ...
            match safety_deposit_config_info {
                ...
                None => return Err(UniMoonError::InvalidOperation.into()),
            }
        }
        Ok(())
    }
