...
impl PrintProgramError for UniMoonError {
    fn print<E>(&self) {
        msg!(&self.to_string());
    }
}

impl From<UniMoonError> for ProgramError {
    fn from(e: UniMoonError) -> Self {
        ProgramError::Custom(e as u32)
    }
}

impl<T> DecodeError<T> for UniMoonError {
