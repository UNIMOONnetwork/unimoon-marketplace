  ...
  return (
    <InstructionsModal
      ...
      cardProps={[
        {
          title: 'Placing a Bid',
          description: `Once you find an NFT you’d like to own, place a bid on the auction page. Keep in mind the amount of UNIMOON you bid will be locked in your wallet for the remainder of the auction.`,
