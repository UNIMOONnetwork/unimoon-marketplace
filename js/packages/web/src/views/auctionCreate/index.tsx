  ...
  return (
    <>
      <Row className="call-to-action">
        <h2>List an item</h2>
        <p>
          First time listing on Unimoon? <a>Read our sellers' guide.</a>
        </p>
      </Row>
  ...
  return (
    ...
    >
      ...
      <div className="waiting-title">
        Your creation is being listed with Unimoon...
      </div>
...
const Congrats = (props: {
  ...
  const newTweetURL = () => {
    const params = {
      text: "I've created a new NFT auction on Unimoon, check it out!",
      url: `${
